    ...
    <div class="col-xs-12 col-sm-3 col-md-3">
        <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-color: #343C46;;">
            ...
            <div class="panel-content">
                ...
                <!-- <h4>Usuarios</h4> -->
                <!--    <p></p> -->
                <a href="{{ route('voyager.carreras.index') }}" class="btn btn-primary btn-lg">CARRERAS</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-3 col-md-3">
        <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-color: #343C46;">
            ...
            <div class="panel-content">
                ...
                <!-- <h4>Usuarios</h4> -->
                <!--    <p></p> -->
                <a href="{{ route('voyager.asignaturas.index') }}" class="btn btn-primary btn-lg">ASIGNATURAS</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-3 col-md-3">
        <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-color: #343C46;">
            ...
            <div class="panel-content">
                ...
                <!-- <h4>Usuarios</h4> -->
                <!--    <p></p> -->
                <a href="{{ route('voyager.horarios.index') }}" class="btn btn-primary btn-lg">HORARIOS</a>
            </div>
        </div>
    </div>
