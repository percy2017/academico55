...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">WebAcademico, esta deseñada para que su manejo sea facil e instuitiva. con un diseño moderno y profesional.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">Los modulos son los componentes del sistemas, que sirven para establecer flujo de trabajo.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">WebAcademico, esta desarrollado con las mejores practica de seguridad en internet.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    ...
                    <p class="mb-4">Web Academico soporta todas las pantallas de Dispositivos, como ser Smarthphone, Table, Laptop, Descktop, SmartTV, etc.</p>
    ...
    <div class="section light-bg">
        <div class="container">
            ...
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#communication">Inscripción</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#schedule">Programación</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#messages">Notas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#livechat">Seguridad</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div>
                            ...
                            <h2>Modulo de Inscripción</h2>
                            <p class="lead">El modulo de Inscripciónes administra, a los estudiantes y registros</p>
                ...
                <div class="tab-pane fade" id="schedule">
                    <div class="d-flex flex-column flex-lg-row">
                        <div>
                            <h2>Modulo de Programación </h2>
                            <p class="lead">El modulo de programacicones. es para administrar las programaciones de los estudiantes a las materias.</p>
                            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla vel sapien. Vestibulum sit amet mattis ante. Ut placerat dui eu nulla
                                congue tincidunt ac a nibh. Mauris accumsan pulvinar lorem placerat volutpat. Praesent quis facilisis elit. Sed condimentum neque quis ex porttitor,
                            </p>
                            <p> malesuada faucibus augue aliquet. Sed elit est, eleifend sed dapibus a, semper a eros. Vestibulum blandit vulputate pharetra. Phasellus lobortis leo a nisl euismod, eu faucibus justo sollicitudin. Mauris consectetur, tortor
                ...
                <div class="tab-pane fade" id="messages">
                    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <div>
                            <h2>Modulo -  Notas</h2>
                            <p class="lead">EL modulo de notas gestiona el historial de las notas de los estudiantes</p>
                            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla vel sapien. Vestibulum sit amet mattis ante. Ut placerat dui eu nulla
                                congue tincidunt ac a nibh. Mauris accumsan pulvinar lorem placerat volutpat. Praesent quis facilisis elit. Sed condimentum neque quis ex porttitor,
                            </p>
                            <p> malesuada faucibus augue aliquet. Sed elit est, eleifend sed dapibus a, semper a eros. Vestibulum blandit vulputate pharetra. Phasellus lobortis leo a nisl euismod, eu faucibus justo sollicitudin. Mauris consectetur, tortor
                ...
                <div class="tab-pane fade" id="livechat">
                    <div class="d-flex flex-column flex-lg-row">
                        <div>
                            ...
                            <p class="lead">Seguridad es un modulo que viene por defecto en WebAcademico, y sirve para adminstar a los usuarios, roles y permisos del sistema.</p>
                            <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer rutrum, urna eu pellentesque pretium, nisi nisi fermentum enim, et sagittis dolor nulla vel sapien. Vestibulum sit amet mattis ante. Ut placerat dui eu nulla
                                congue tincidunt ac a nibh. Mauris accumsan pulvinar lorem placerat volutpat. Praesent quis facilisis elit. Sed condimentum neque quis ex porttitor,
                            </p>
                            <p> malesuada faucibus augue aliquet. Sed elit est, eleifend sed dapibus a, semper a eros. Vestibulum blandit vulputate pharetra. Phasellus lobortis leo a nisl euismod, eu faucibus justo sollicitudin. Mauris consectetur, tortor
    ...
    <footer class="my-5 text-center">
        ...
        <p class="mb-2"><small>COPYRIGHT © 2018. TODOS LOS DERECHOS RESERVADOS PARA <a href="#">LOGINWEB</a></small></p>
